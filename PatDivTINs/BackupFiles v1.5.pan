...
;stop
filesave vSecondSave,"Cust_hist Backup"+datepattern(today(),"MMYY")+".txt","",vExportArray
window "PatDivTINs"
saveacopyas "patronageadmin:Desktop:PatDivUpdate:Backups:"+"PatDivTINs Backup"+datepattern(today(),"MMYY")
